...
class MyHistoryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        MyHistoryTableView.register(UINib(nibName: "ScoreTableCell", bundle: nil), forCellReuseIdentifier: "ScoreTableCellReuse")
    ...
    @IBAction func menubar(_ sender: Any) {
      ...
      func getMyEntries(){
          ...
          print(dict)
          APIManager.callApi.getApiRequest(controller: self, method: APIList.shared.app_completedFixtures,header: headers, parameters: dict ) {(response, status, data) in
...
extension MyHistoryViewController: UITableViewDelegate, UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        ...
        func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
            return 190//UITableView.automaticDimension
        }
