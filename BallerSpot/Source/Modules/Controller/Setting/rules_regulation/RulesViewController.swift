...
//     }
    ...
    func loadHTMLStringImage() {
        ...
        let htmlString = self.allRules["rules"] as! String
    ...
    func getRules(){
        ...
        APIManager.callApi.getApiRequest(controller: self, method: APIList.shared.getrules,header: headers, parameters: ["" : ""] ) {(response, status, data) in
       ...
       //                        self.allLeagues = [response?.value(forKey: "api")] as! [NSString : Any]
                        ...
                        //   let myArr1 = jsondata["data"] as! [String : AnyObject]
                            self.allRules = jsondata["data"] as! [String : Any]
